...
<temps:page_admin_template>
	<jsp:attribute name="title"><c:out value="Insert new post" /></jsp:attribute>
	<jsp:attribute name="page"><c:out value="admin" /></jsp:attribute>
	
	<jsp:attribute name="content">
		<form:form method="post" modelAttribute="post">
			<c:if test="${success}">
				<div class="alert alert-success">Post successfully inserted!</div>
			</c:if>
			<!-- CSRF TOKEN  -->
			...
			<br />
			<form:button class="btn btn-dark btn-lg btn-block">Insert post</form:button>
		</form:form>
	</jsp:attribute>
